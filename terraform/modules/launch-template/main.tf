...
### OUTPUTS ###
output "id"  { value = aws_launch_template.tpl.id }
output "arn" { value = aws_launch_template.tpl.arn }

output "policy_modify_versions" { value = aws_iam_policy.iam-tpl-versions.id }
